...
const About = () => {
    return (
        <div className="bg-background text-white min-h-screen selection:bg-primary/30">
            ...
            {/* Simple Nav */}
            <nav className="h-20 px-4 sm:px-8 flex items-center justify-between border-b border-white/5 glass sticky top-0 z-50">
                ...
                <Link to="/login" className="text-[10px] font-bold uppercase tracking-widest px-4 sm:px-6 py-2 border border-white/10 rounded-xl hover:bg-white/5 transition-all">Sign In</Link>
            </nav>

            <main id="main-content" className="max-w-5xl mx-auto px-4 sm:px-8 py-20 sm:py-32 relative">
                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-20 mt-16 sm:mt-20">
                    ...
                    <div className="grid grid-cols-1 gap-8 animate-in" style={{ animationDelay: '0.2s' }}>
                        <div className="glass p-8 sm:p-10 rounded-[32px] sm:rounded-[40px] border-primary/20">
                            <Target className="text-primary mb-6" size={28} />
                            <h2 className="mb-3">Our Core Mandate</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="glass p-8 sm:p-10 rounded-[28px] sm:rounded-[32px]">
                                <Activity className="text-accent mb-4" size={24} />
                                <h3 className="font-bold mb-1 text-sm">Real-time</h3>
                                <p className="text-[10px] text-text-muted">Continuous observation.</p>
                            </div>
                            <div className="glass p-8 sm:p-10 rounded-[28px] sm:rounded-[32px]">
                                <ShieldCheck className="text-secondary mb-4" size={24} />
                                <h3 className="font-bold mb-1 text-sm">Validated</h3>
            ...
            <footer className="py-20 px-4 sm:px-8 text-center text-text-muted border-t border-white/5">
